"""
Django settings for newprd_42987 project.
...
ROOT_URLCONF = 'newprd_42987.urls'
...
WSGI_APPLICATION = 'newprd_42987.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newprd_42987 API",
    "DESCRIPTION": "API documentation for newprd_42987 App",
    "VERSION": "v1",
}
